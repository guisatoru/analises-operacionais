...
import { X, Loader2, AlertCircle, Clock, Briefcase } from 'lucide-react';
 ...
 * 
 * Por que existe: Isola todo o estado de formulário para tomar decisões contratuais,
 * exibindo os dados de faltas/atestados coletados do ponto e o histórico prévio.
 * Envia o registro da decisão para a API do Django de forma encapsulada.
 */
export default function DecisaoTerminoModal({
  ...
  // Salva a decisão na API do Django
